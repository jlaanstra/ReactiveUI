...
namespace ReactiveUI.Tests
{
    ...
    public class ReactiveNotifyPropertyChangedMixinTest
    {
        ...
        public void OFPNamedPropertyTest()
        {
            (new TestScheduler()).With(sched => {
                var fixture = new TestFixture();
                var changes = fixture.ObservableForProperty<TestFixture, string>(tf => tf.IsOnlyOneWord).CreateCollection();
        ...
        public void OFPNamedPropertyTestNoSkipInitial()
        {
            (new TestScheduler()).With(sched => {
                ...
                var changes = fixture.ObservableForProperty<TestFixture, string>(tf => tf.IsOnlyOneWord, skipInitial: false).CreateCollection();
        ...
        public void OFPNamedPropertyTestBeforeChange()
        {
            (new TestScheduler()).With(sched => {
                var fixture = new TestFixture() { IsOnlyOneWord = "Pre" };
                var changes = fixture.ObservableForProperty<TestFixture, string>(tf => tf.IsOnlyOneWord, beforeChange: true).CreateCollection();
