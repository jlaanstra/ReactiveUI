...
namespace ReactiveUI
{
    ...
    public class ReactiveCollection_old<T> : ObservableCollection<T>, IReactiveCollection<T>, IDisposable
    {
        /// <summary>
        /// Constructs a ReactiveCollection.
        /// </summary>
        public ReactiveCollection_old() { setupRx(); }
        ...
        /// list.</param>
        public ReactiveCollection_old(IEnumerable<T> list) { setupRx(list); }
